/**
 * Illustrates how to create a group by including processes from another * group.
 * This application is meant to be run with 4 processes. 
 * the default group made of all processes 
 * creates another group from it, keeping only processes 1 and 3.
 **/
